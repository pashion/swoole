...
class Sms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIDovwG5tJLSXK"; // AccessKeyId

        $accessKeySecret = "RIFuyo5hLN6gChNF7bOlre92tyb3OG"; // AccessKeySecret
    ...
    public static function sendSms($phone, $code) {
        ...
        $request->setSignName("pashioner");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_137830160");
